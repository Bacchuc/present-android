...
public class CommonUtil extends Application {
    ...
    *
    * */
    static public Intent shareInfor(Context context, int shareInfor) {

        Intent intent = new Intent();
        intent.setAction(Intent.ACTION_SEND);
        intent.putExtra(Intent.EXTRA_TEXT, context.getResources().getString(shareInfor));
    ...
    *
    * */
    static public void startDownLoadingTask(Context context, String fileUrl) {

        DownloadManager downloadManager = (DownloadManager) context.getSystemService(Context.DOWNLOAD_SERVICE);
        fileUrl = "http://www.aceclound.cn/" + fileUrl;
        ...
        try {
            ...
            Toast.makeText(context, "请打开下载管理器", Toast.LENGTH_SHORT).show();
        }
    }
